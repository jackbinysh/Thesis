...
\usepackage{warwickthesis,setspace,graphicx, amsfonts, amssymb,amsbsy,epigraph}     %!  setspace is used to control linepacing
...
\renewcommand{\thesisdepartmentname}{Centre for Complexity Science}    %! The name of
                                                  %   the department
