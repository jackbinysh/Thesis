...
\usepackage{floatpag,verbatim ,hyperref,warwickthesis,setspace,graphicx, amsfonts, amsmath, amssymb,amsbsy,epigraph}     %!  setspace is used to control linepacing
...
\renewcommand{\thesisauthorno}{1456012}  %! your university number, used on the library copyright page.
...
\renewcommand{\thesistitle}{Construction and Dynamics of Knotted Fields in Soft Matter Systems}     %% The title of your thesis; use
                                     %% mixed-case.
...
\renewcommand{\thesissupervisor}{Gareth Alexander}
...
\begin{thesisabstract}               %% Use this to write your thesis
  ...
  \begin{singlespace}       %! uncomment this if you need single spacing
    \input {FrontMatter/Abstract.tex}       %!           don't forget the end spacing!
...
\pagenumbering{arabic} %! Begins arabic numerals start from page 1.
 ...
 \input{Chapters/MaxwellsTheoryOfSolidAngle.tex}
 \input{Chapters/StableAndUnstableKnots.tex}
 \input{Chapters/TwistBend.tex}
%!
