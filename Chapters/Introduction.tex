...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.6\linewidth]{\IntroductionFigures/PontryaginThom.pdf}
\caption{hi }
\label{fig:PT}
\end{figure}
